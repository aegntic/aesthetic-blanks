...
/**
 * Motion primitives (shared kit). Bleibtgleich-specific reveals live in:
 * - TruthText (word/letter random-stagger opacity — the signature "truth" reveal)
 * - Rule (thin divider grow on enter)
 * - HeroWrap (page-wrap scale/rotate/blur-in — app/page.tsx)
 * - GridOverlay (12-col toggle), ProjectCard (hover image-storm)
 *
 * Kept types: scale (scroll-linked), split/mask (line wipe), stagger, fade,
 * slide, gate, mega (menu), marquee.
 */
